          ...
          <div className="bg-slate-800/80 backdrop-blur border border-slate-700/60 rounded-2xl p-6 sm:p-8 shadow-xl">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <Users className="w-4 h-4" /> Social Space
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 pt-6 border-t border-slate-700/60">
              <div className="bg-slate-900/60 rounded-xl p-4 border border-slate-700/40">
                <p className="text-xs font-medium text-slate-400">Reputation Points</p>
                <p className="text-xl font-bold text-indigo-400 mt-1">
                  {userDetails?.points ?? 0} pts
                </p>
              </div>
              <div className="bg-slate-900/60 rounded-xl p-4 border border-slate-700/40">
                <p className="text-xs font-medium text-slate-400">Active Membership</p>
                <p className="text-xl font-bold text-emerald-400 mt-1">
                  {userDetails?.subscription?.plan || "Free"} Plan
                </p>
              </div>
              <div className="bg-slate-900/60 rounded-xl p-4 border border-slate-700/40">
                <p className="text-xs font-medium text-slate-400">Friends Connected</p>
                <p className="text-xl font-bold text-amber-400 mt-1">
                  {userDetails?.friends?.length || 0} Friends
                </p>
              </div>
              <div className="bg-slate-900/60 rounded-xl p-4 border border-slate-700/40">
                <p className="text-xs font-medium text-slate-400">Security Audit</p>
                <Link
                  href="/login-history"
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <TrendingUp className="w-5 h-5 text-indigo-400" /> Recent Community Questions
              </h2>
              <Link
                href="/dashboard"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 shadow-inner">
              <Sparkles className="w-4 h-4" /> Modern Full-Stack Developer Platform
            </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-2xl sm:text-4xl font-bold text-white">
              Everything Developers Need in One Sphere
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-slate-900 border border-slate-800 hover:border-indigo-500/40 rounded-2xl p-6 sm:p-8 transition-all space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Q&A Community</h3>
            ...
            <div className="bg-slate-900 border border-slate-800 hover:border-sky-500/40 rounded-2xl p-6 sm:p-8 transition-all space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Social Space</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-900 border border-slate-800 hover:border-emerald-500/40 rounded-2xl p-6 sm:p-8 transition-all space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Reward Points Engine</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-900 border border-slate-800 hover:border-purple-500/40 rounded-2xl p-6 sm:p-8 transition-all space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Device Security & Audit</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-900 border border-slate-800 hover:border-rose-500/40 rounded-2xl p-6 sm:p-8 transition-all space-y-4">
              ...
              <h3 className="text-xl font-bold text-white">Subscription Memberships</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">
                Explore recent questions asked by developers in StackSphere.
              </p>
            </div>
            <Link
              href="/register"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {recentQuestions.slice(0, 4).map((q) => (
              ...
              >
                ...
                <p className="text-slate-400 text-xs line-clamp-2">{q.body}</p>
                <div className="flex items-center justify-between text-xs text-slate-500 pt-2 border-t border-slate-800">
                  <div className="flex gap-1.5">
                    {q.tags.slice(0, 2).map((t: string) => (
                      <span key={t} className="text-indigo-400 font-mono">
                        #{t}
                      </span>
                    ))}
                  </div>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-900/40 via-slate-900 to-slate-950 border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Ready to Join the StackSphere Community?
          </h2>
          <p className="text-slate-400 max-w-xl mx-auto text-sm sm:text-base">
            Create an account in seconds, start asking questions, share social posts, and earn reward points today.
          </p>
          <div className="pt-2">
            <Link
              href="/register"
