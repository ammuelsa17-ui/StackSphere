...
export default function Sidebar() {
  ...
  const guestGroups = [
    {
      title: t("explorePlatform"),
      items: [
        { name: t("homeOverview"), href: "/", icon: Home },
        { name: t("qaCommunity"), href: "/explore/questions", icon: HelpCircle },
        { name: t("socialSpacePreview"), href: "/explore/social", icon: MessageSquare },
        { name: t("plansPricing"), href: "/pricing", icon: CreditCard },
        { name: t("rewardsSystem"), href: "/explore/rewards", icon: Award },
        { name: t("platformFeatures"), href: "/explore/features", icon: Globe },
      ],
    },
    {
      title: t("getStarted"),
      items: [
        { name: t("signIn"), href: "/login", icon: LogIn },
        { name: t("createAccount"), href: "/register", icon: UserPlus },
      ],
    },
  ];
  ...
  const menuGroups = [
    ...
    {
      title: t("socialSpaceGroup"),
      items: [
        { name: t("socialSpace"), href: "/social", icon: MessageSquare },
        { name: t("friendsNetwork"), href: "/social?tab=friends", icon: Users },
      ],
    },
    {
      title: t("rewardsGroup"),
      items: [
        { name: t("myReputationPoints"), href: "/profile", icon: Award },
        { name: t("transferPoints"), href: "/profile?action=transfer", icon: Send },
      ],
    },
    {
      title: t("membershipGroup"),
